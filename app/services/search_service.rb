...
class SearchService
  ...
  def call(items, shipping_region)
    ...
    result = yield error_checking_and_resolve_supplier(items_by_one, items_by_many, items)
  ...
  def resolve_supplier(items_by_one, items_by_many)
  ...
  def error_checking_and_resolve_supplier(items_by_one, items_by_many, items)
    ...
    resolve_supplier(items_by_one, items_by_many)
  end
end
